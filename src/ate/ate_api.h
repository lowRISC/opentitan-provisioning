...
/**
 * Get the version of a personalization blob.
 *
 * @param body The personalization blob body.
 * @param size The size of the blob body.
 * @param[out] blob_version The personalization blob version.
 * @return The result of the operation.
 */
 ...
 * @param blob_version The personalization blob version to use.
